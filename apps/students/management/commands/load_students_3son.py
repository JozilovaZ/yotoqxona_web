...
class Command(BaseCommand):
    help = "TATU SF 3-son Excel faylidan talaba ma'lumotlarini yuklash"

    def handle(self, *args, **options):
        # Building yaratish
        building, created = Building.objects.get_or_create(
            name="TATU SF 3-son DTM",
            defaults={
        ...
        # Qavatlarni yaratish (5 ta qavat)
        floors_data = {
            1: 'female',  # 1-qavat (aralash, boshi ayollar)
            2: 'female',  # 2-qavat ayollar
            3: 'male',    # 3-qavat erkaklar
            4: 'male',    # 4-qavat erkaklar
            5: 'male',    # 5-qavat erkaklar
        }
        floors = {}
        ...
        # Excel faylni o'qish
        wb = openpyxl.load_workbook('jadval_1/TATU SF 3-son.xlsx')
        ...
        for row in ws.iter_rows(min_row=3, max_row=ws.max_row):
            ...
            # Jinsni aniqlash - familiya va ism oxiriga qarab
            gender = 'male'
            full_lower = full_name_raw.lower()
            if any(full_lower.endswith(s) or f' {s} ' in f' {full_lower} ' for s in female_suffixes):
                gender = 'female'
            else:
            ...
            if passport:
                ...
                passport = f"3SON_NO_ID_{vals.get(1, 0)}"
            ...
            student, s_created = Student.objects.update_or_create(
                ...
                defaults={
                    ...
                    'gender': gender,
                    'phone': phone,
                    'faculty': faculty if faculty else 'KI',
